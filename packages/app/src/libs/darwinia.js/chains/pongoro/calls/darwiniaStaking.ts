 ...
 *
 * `DarwiniaStaking`'s storages: {@link: module:pangoro/darwiniaStaking/storages}
 *
 * @module pangoro/darwiniaStaking/calls
 */
...
export const getDarwiniaStaking = (dispatch: Dispatch, metadata: Metadata) => {
  return {
    ...
    /**
     * Similar to {@link: pangoro/darwiniaStaking/calls/stake}, but with scale encoded args.
     *
    ...
    /**
     * Similar to {@link: pangoro/darwiniaStaking/calls/unstake}, but with scale encoded args.
     *
     * @param {Hex | Uint8Array} argsBytes the args bytes
     * @instance
     */
    ...
    /**
     * Similar to {@link: pangoro/darwiniaStaking/calls/restake}, but with scale encoded args.
     *
     * @param {Hex | Uint8Array} argsBytes the args bytes
     * @instance
     */
    ...
    /**
     * Similar to {@link: pangoro/darwiniaStaking/calls/claim}, but with scale encoded args.
     *
     * @param {Hex | Uint8Array} argsBytes the args bytes
     * @instance
     */
    ...
    /**
     * Similar to {@link: pangoro/darwiniaStaking/calls/collect}, but with scale encoded args.
     *
     * @param {Hex | Uint8Array} argsBytes the args bytes
     * @instance
     */
    ...
    /**
     * Similar to {@link: pangoro/darwiniaStaking/calls/nominate}, but with scale encoded args.
     *
     * @param {Hex | Uint8Array} argsBytes the args bytes
     * @instance
     */
    ...
    /**
     * Similar to {@link: pangoro/darwiniaStaking/calls/chill}, but with scale encoded args.
     *
     * @param {Hex | Uint8Array} argsBytes the args bytes
     * @instance
     */
