 ...
 *
 * `Session`'s storages: {@link: module:pangolin/session/storages}
 *
 * @module pangolin/session/calls
 */
...
export const getSession = (dispatch: Dispatch, metadata: Metadata) => {
  return {
    ...
    /**
     * Similar to {@link: pangolin/session/calls/setKeys}, but with scale encoded args.
     *
    ...
    /**
     * Similar to {@link: pangolin/session/calls/purgeKeys}, but with scale encoded args.
     *
     * @param {Hex | Uint8Array} argsBytes the args bytes
     * @instance
     */
