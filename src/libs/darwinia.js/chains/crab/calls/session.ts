 ...
 *
 * `Session`'s storages: {@link: module:crab/session/storages}
 *
 * @module crab/session/calls
 */
...
export const getSession = (dispatch: Dispatch, metadata: Metadata) => {
  return {
    ...
    /**
     * Similar to {@link: crab/session/calls/setKeys}, but with scale encoded args.
     *
    ...
    /**
     * Similar to {@link: crab/session/calls/purgeKeys}, but with scale encoded args.
     *
     * @param {Hex | Uint8Array} argsBytes the args bytes
     * @instance
     */
