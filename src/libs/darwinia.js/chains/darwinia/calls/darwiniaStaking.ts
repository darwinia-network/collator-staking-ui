...
export const getDarwiniaStaking = (dispatch: Dispatch, metadata: Metadata) => {
  return {
    ...
    /**
     * Similar to {@link: darwinia/darwiniaStaking/calls/restake}, but with scale encoded args.
     *
     * @param {Hex | Uint8Array} argsBytes the args bytes
     * @instance
     */
    ...
    /**
     * Similar to {@link: darwinia/darwiniaStaking/calls/claim}, but with scale encoded args.
     *
     * @param {Hex | Uint8Array} argsBytes the args bytes
     * @instance
     */
